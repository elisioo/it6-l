...
BEGIN
    ...
    -- Insert into Points table with calculated points
    INSERT INTO Points (membership_id, sales_id, total_purchase, points_amount)
    VALUES (p_membership_id, p_sales_id, v_total_purchase, v_points_earned);

    -- Get the last inserted points_id
    SET v_points_id = LAST_INSERT_ID();

    -- Insert into Points_Details table using points_amount
    ...
    VALUES (
        v_points_id,
        v_points_earned,  -- Use the calculated points from Points
